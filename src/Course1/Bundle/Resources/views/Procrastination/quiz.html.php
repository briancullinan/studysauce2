...
<div class="panel-pane course1 step2 <?php print ($complete ? ' right' : ''); ?>" id="course1_procrastination-step2">
    <div class="pane-content">
        ...
        <div class="highlighted-link <?php print ($complete ? ' valid' : ' invalid'); ?>">
            ...
            <a href="<?php print $view['router']->generate('course1_procrastination', ['_step' => 3]); ?>" class="more">Next</a>
        </div>
