...
<div class="panel-pane course1" id="lesson1-step1">
    ...
    <div class="pane-content">
        ...
        <div class="player-wrapper">
            ...
            <iframe id="ytplayer" src="https://www.youtube.com/embed/KgCJ5yDISNs?rel=0&controls=0&modestbranding=1&showinfo=0&enablejsapi=1&playerapiid=ytplayer" frameborder="0"></iframe>
        </div>
