...
class Grade
{
    ...
    public function getGrade()
    {
        if(empty($this->getCourse()))
            return null;
        return CalcController::convertToScale($this->getCourse()->getSchedule()->getGradeScale(), $this->getScore())[0];
    }
    ...
    public function getGPA()
    {
        if(empty($this->getCourse()))
            return null;
        return CalcController::convertToScale($this->getCourse()->getSchedule()->getGradeScale(), $this->getScore())[1];
    }
