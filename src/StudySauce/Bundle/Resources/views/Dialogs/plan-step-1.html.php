...
<form action="<?php print $view['router']->generate('profile_update'); ?>" method="post">
    <p>How difficult do you expect each class to be?  This will help us determine how much time you should spend studying for each.</p>
    <header>
    ...
    <div class="highlighted-link">
        ...
        <a href="#plan-step-2" data-toggle="modal" class="more">Get started</a>
    </div>
</form>
<?php $view['slots']->stop();
