...
<form action="<?php print $view['router']->generate('profile_update'); ?>" method="post">
    ...
    <div class="highlighted-link setup-mode invalid">
        ...
        <button type="submit" data-target="#plan-step-2" data-toggle="modal" class="more">Next</button>
    </div>
    <div class="highlighted-link invalid">
        ...
        <button type="submit" data-target="#plan-step-3" data-toggle="modal" class="more">Next</button>
    </div>
</form>
<?php $view['slots']->stop();
