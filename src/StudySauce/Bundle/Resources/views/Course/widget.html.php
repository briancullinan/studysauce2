...
<div class="widget-wrapper">
    <div class="widget course-widget">
        ...
        <div class="highlighted-link">
            <?php if($completed >= Course1Bundle::COUNT_LEVEL + Course2Bundle::COUNT_LEVEL) { ?>
                <h4>Complete!</h4>
            ...
            <?php } else { ?>
                <a href="<?php print $view['router']->generate('_welcome'); ?>course/2/lesson/<?php print $next; ?>/step/0" class="more">Next module</a>
            <?php } ?>
        </div>
    </div>
</div>