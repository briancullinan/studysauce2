...
<?php $user->getFirstName(); ?> wants to invite you to become an accountability partner.<br />
<br />
...
<br />
You can work out the specific expectations with <?php $user->getFirstName(); ?>, but a good accountability partner tends to have the following attributes:<br />
