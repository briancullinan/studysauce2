...
class Event {
	...
	public function toArray() {
		...
		if ($this->allDay) {
			$_format = 'Y-m-d'; // output like "2013-12-29"
		}
		else {
			$_format = 'c'; // full ISO8601 output, like "2013-12-29T09:00:00+08:00"
		}

		// Serialize dates into strings
		$array['start'] = $this->start->format($_format);
		if (isset($this->end)) {
			$array['end'] = $this->end->format($_format);
		}
