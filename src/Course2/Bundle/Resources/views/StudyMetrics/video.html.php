...
<div class="panel-pane course2 step1" id="course2_study_metrics-step1">
    ...
    <div class="pane-content">
        ...
        <div class="player-wrapper">
            <iframe id="course2_study_metrics-player" src="https://www.youtube.com/embed/xJv-3t7qAYc?rel=0&amp;controls=0&amp;modestbranding=1&amp;showinfo=0&amp;enablejsapi=1&amp;origin=<?php print $app->getRequest()->getScheme() . '://' . $app->getRequest()->getHttpHost(); ?>"></iframe>
        </div>
