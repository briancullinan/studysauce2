...
<div class="panel-pane course2 step2 <?php print ($complete ? ' right' : ''); ?>" id="course2_group_study-step2">
    <div class="pane-content">
        ...
        <div class="highlighted-link <?php print ($complete ? ' valid' : ' invalid'); ?>">
            ...
            <a href="<?php print $view['router']->generate('course2_group_study', ['_step' => 3]); ?>" class="more">Next</a>
        </div>
