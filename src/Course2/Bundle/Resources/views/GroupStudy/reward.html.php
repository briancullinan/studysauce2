...
<div class="panel-pane course2 step3" id="course2_group_study-step3">
    <div class="pane-content">
        <h2>Choose your group wisely.</h2>
        <?php foreach ($view['assetic']->image(['@Course2Bundle/Resources/public/images/reward7.gif'], [], ['output' => 'bundles/course2/images/*']) as $url): ?>
        ...
        <div class="highlighted-link">
            <a href="<?php print $view['router']->generate('course2_group_study', ['_step' => 4]); ?>" class="more">Next</a>
        </div>
