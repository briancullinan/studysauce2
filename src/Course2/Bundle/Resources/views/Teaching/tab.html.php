    ...
    <div class="pane-content">
        ...
        <div class="player-divider">
            <div class="player-wrapper">
                <?php foreach ($view['assetic']->image(['@Course2Bundle/Resources/public/images/intro8.jpg'], [], ['output' => 'bundles/course2/images/*']) as $url): ?>
        ...
        <div class="highlighted-link">
            ...
            <?php } else { ?>
                <a href="<?php print $view['router']->generate('course2_teaching', ['_step' => 1]); ?>" class="more">Launch</a>
            <?php } ?>
        </div>
