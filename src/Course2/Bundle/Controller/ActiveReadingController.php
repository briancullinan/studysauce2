...
class ActiveReadingController extends Controller
{
    ...
    public function wizardAction($_step = 0)
    {
        ...
        {
            case 0:
                return $this->render('Course2Bundle:ActiveReading:tab.html.php');
                break;
            case 1:
                return $this->render('Course2Bundle:ActiveReading:video.html.php');
                break;
            case 2:
                ...
                break;
            case 3:
                return $this->render('Course2Bundle:ActiveReading:reward.html.php');
                break;
            case 4:
                return $this->render('Course2Bundle:ActiveReading:investment.html.php');
                break;
            default:
    ...
    public function updateAction(Request $request)
    {
        ...
        return $this->forward('Course2Bundle:ActiveReading:wizard', ['_step' => 2, '_format' => 'tab']);
    }
}
