...
class Course3Cest
{
    ...
    public function tryCourse3Strategies(AcceptanceTester $I)
    {
        ...
        $I->click('#course3_strategies-step2 .highlighted-link a:first-child');
        $I->wait(15);
        $I->click('#course3_strategies-step2 .highlighted-link a:last-child');
        $I->wait(5);
    ...
    public function tryCourse3GroupStudy (AcceptanceTester $I) {
        ...
        $I->click('#course3_group_study-step2 .highlighted-link a:first-child');
        $I->wait(15);
        $I->click('#course3_group_study-step2 .highlighted-link a:last-child');
        $I->wait(5);
    ...
    public function tryCourse3Teaching (AcceptanceTester $I) {
        ...
        $I->click('#course3_teaching-step2 .highlighted-link a:first-child');
        $I->wait(15);
        $I->click('#course3_teaching-step2 .highlighted-link a:last-child');
        $I->wait(5);
    ...
    public function tryCourse3ActiveReading (AcceptanceTester $I) {
        ...
        $I->click('#course3_active_reading-step2 .highlighted-link a:first-child');
        $I->wait(15);
        $I->click('#course3_active_reading-step2 .highlighted-link a:last-child');
        $I->wait(5);
    ...
    public function tryCourse3SpacedRepetition (AcceptanceTester $I) {
        ...
        $I->click('#course3_spaced_repetition-step2 .highlighted-link a:first-child');
        $I->wait(15);
        $I->click('#course3_spaced_repetition-step2 .highlighted-link a:last-child');
        $I->wait(5);
