...
<div class="panel-pane course3 step1" id="course3_active_reading-step1">
    ...
    <div class="pane-content">
        ...
        <div class="player-wrapper">
            <iframe id="course3_active_reading-player" src="https://www.youtube.com/embed/b3Bo1ok_aXo?rel=0&amp;controls=0&amp;modestbranding=1&amp;showinfo=0&amp;enablejsapi=1&amp;origin=<?php print $app->getRequest()->getScheme() . '://' . $app->getRequest()->getHttpHost(); ?>"></iframe>
        </div>
