...
<div class="panel-pane course3 step3" id="course3_strategies-step3">
    <div class="pane-content">
        <h2>Having a good strategy is key to studying</h2>
        <?php foreach ($view['assetic']->image(['@Course3Bundle/Resources/public/images/reward6.gif'], [], ['output' => 'bundles/course3/images/*']) as $url): ?>
        ...
        <div class="highlighted-link">
            <a href="<?php print $view['router']->generate('course3_strategies', ['_step' => 4]); ?>" class="more">Next</a>
        </div>
